 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const tS=sr.forwardRef(({color:a="currentColor",size:e=24,strokeWidth:t=2,absoluteStrokeWidth:i,className:s="",children:o,iconNode:u,...c},d)=>sr.createElement("svg",{ref:d,...eS,width:e,height:e,stroke:a,strokeWidth:i?Number(t)*24/Number(e):t,className:D0("lucide",s),...c},[...u.map(([h,p])=>sr.createElement(h,p)),...Array.isArray(o)?o:[o]]));/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const On=(a,e)=>{const t=sr.forwardRef(({className:i,...s},o)=>sr.createElement(tS,{ref:o,iconNode:e,className:D0(`lucide-${Qy(hg(a))}`,`lucide-${a}`,i),...s}));return t.displayName=hg(a),t};/**
 * @license lucide-react v0.487.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`].filter(rl).join(`
`)),u=Wh(u),u=s0(u,t),u=a0(u,t),c=Wh(c),c=s0(c,t),c=a0(c,t),u=o0(u),c=o0(c),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+x);const L=b+S+u,C=b+x+c,R=n0(s,s.VERTEX_SHADER,L),N=n0(s,s.FRAGMENT_SHADER,C);s.attachShader(M,R),s.attachShader(M,N),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function I(B){if(a.debug.checkShaderErrors){const X=s.getProgramInfoLog(M)||"",W=s.getShaderInfoLog(R)||"",ne=s.getShaderInfoLog(N)||"",te=X.trim(),Q=W.trim(),q=ne.trim();let j=!0,fe=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(j=!1,typeof a.debug.onShaderError=="function")a.debug.onShaderError(s,M,R,N);else{const ae=r0(s,R,"vertex"),O=r0(s,N,"fragment");Ct("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var S0,fs,$a,Fp,Js,M0,Op,ZC=function(){return typeof window<"u"},Ur={},qs=180/Math.PI,Ka=Math.PI/180,Ga=Math.atan2,E0=1e8,kp=/([A-Z])/g,QC=/(left|right|width|margin|padding|x)/i,JC=/[\s,\(]\S/,rr={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},tp=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},eR=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},tR=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},nR=function(e,t){return t.set(t.t,t.p,e===1?t.e:e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},iR=function(e,t){var i=t.s+t.c*e;t.set(t.t,t.p,~~(i+(i<0?-.5:.5))+t.u,t)},Jv=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},ex=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},rR=function(e,t,i){return e.style[t]=i},sR=function(e,t,i){return e.style.setProperty(t,i)},aR=function(e,t,i){return e._gsap[t]=i},oR=function(e,t,i){return e._gsap.scaleX=e._gsap.scaleY=i},lR=function(e,t,i,s,o){var u=e._gsap;u.scaleX=u.scaleY=i,u.renderTransform(o,u)},uR=function(e,t,i,s,o){var u=e._gsap;u[t]=i,u.renderTransform(o,u)},Zt="transform",ii=Zt+"Origin",cR=function a(e,t){var i=this,s=this.target,o=s.style,u=s._gsap;if(e in Ur&&o){if(this.tfm=this.tfm||{},e!=="transform")e=rr[e]||e,~e.indexOf(",")?e.split(",").forEach(function(c){return i.tfm[c]=Cr(s,c)}):this.tfm[e]=u.x?u[e]:Cr(s,e),e===ii&&(this.tfm.zOrigin=u.zOrigin);else return rr.transform.split(",").forEach(function(c){return a.call(i,c,t)});if(this.props.indexOf(Zt)>=0)return;u.svg&&(this.svgo=s.getAttribute("data-svg-origin"),this.props.push(ii,t,"")),e=Zt}(o||t)&&this.props.push(e,t,o[e])},tx=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},fR=function(){var e=this.props,t=this.target,i=t.style,s=t._gsap,o,u;for(o=0;o<e.length;o+=3)e[o+1]?e[o+1]===2?t[e[o]](e[o+2]):t[e[o]]=e[o+2]:e[o+2]?i[e[o]]=e[o+2]:i.removeProperty(e[o].substr(0,2)==="--"?e[o]:e[o].replace(kp,"-$1").toLowerCase());if(this.tfm){for(u in this.tfm)s[u]=this.tfm[u];s.svg&&(s.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),o=Op(),(!o||!o.isStart)&&!i[Zt]&&(tx(i),s.zOrigin&&i[ii]&&(i[ii]+=" "+s.zOrigin+"px",s.zOrigin=0,s.renderTransform()),s.uncache=1)}},nx=function(e,t){var i={target:e,props:[],revert:fR,save:cR};return e._gsap||ri.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(s){return i.save(s)}),i},ix,np=function(e,t){var i=fs.createElementNS?fs.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):fs.createElement(e);return i&&i.style?i:fs.createElement(e)},_i=function a(e,t,i){var s=getComputedStyle(e);return s[t]||s.getPropertyValue(t.replace(kp,"-$1").toLowerCase())||s.getPropertyValue(t)||!i&&a(e,oo(t)||t,1)||""},T0="O,Moz,ms,Ms,Webkit".split(","),oo=function(e,t,i){var s=t||Js,o=s.style,u=5;if(e in o&&!i)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);u--&&!(T0[u]+e in o););return u<0?null:(u===3?"ms":u>=0?T0[u]:"")+e},ip=function(){ZC()&&window.document&&(S0=window,fs=S0.document,$a=fs.documentElement,Js=np("div")||{style:{}},np("div"),Zt=oo(Zt),ii=Zt+"Origin",Js.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",ix=!!oo("perspective"),Op=ri.core.reverting,Fp=1)},w0=function(e){var t=e.ownerSVGElement,i=np("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),s=e.cloneNode(!0),o;s.style.display="block",i.appendChild(s),$a.appendChild(i);try{o=s.getBBox()}catch{}return i.removeChild(s),$a.removeChild(i),o},A0=function(e,t){for(var i=t.length;i--;)if(e.hasAttribute(t[i]))return e.getAttribute(t[i])},rx=function(e){var t,i;try{t=e.getBBox()}catch{t=w0(e),i=1}return t&&(t.width||t.height)||i||(t=w0(e)),t&&!t.width&&!t.x&&!t.y?{x:+A0(e,["x","cx","x1"])||0,y:+A0(e,["y","cy","y1"])||0,width:0,height:0}:t},sx=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&rx(e))},vs=function(e,t){if(t){var i=e.style,s;t in Ur&&t!==ii&&(t=Zt),i.removeProperty?(s=t.substr(0,2),(s==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),i.removeProperty(s==="--"?t:t.replace(kp,"-$1").toLowerCase())):i.removeAttribute(t)}},ds=function(e,t,i,s,o,u){var c=new ni(e._pt,t,i,0,1,u?ex:Jv);return e._pt=c,c.b=s,c.e=o,e._props.push(i),c},C0={deg:1,rad:1,turn:1},dR={grid:1,flex:1},xs=function a(e,t,i,s){var o=parseFloat(i)||0,u=(i+"").trim().substr((o+"").length)||"px",c=Js.style,d=QC.test(t),h=e.tagName.toLowerCase()==="svg",p=(h?"client":"offset")+(d?"Width":"Height"),_=100,g=s==="px",y=s==="%",E,M,S,x;if(s===u||!o||C0[s]||C0[u])return o;if(u!=="px"&&!g&&(o=a(e,t,i,"px")),x=e.getCTM&&sx(e),(y||u==="%")&&(Ur[t]||~t.indexOf("adius")))return E=x?e.getBBox()[d?"width":"height"]:e[p],sn(y?o/E*_:o/100*E);if(c[d?"width":"height"]=_+(g?u:s),M=s!=="rem"&&~t.indexOf("adius")||s==="em"&&e.appendChild&&!h?e:e.parentNode,x&&(M=(e.ownerSVGElement||{}).parentNode),(!M||M===fs||!M.appendChild)&&(M=fs.body),S=M._gsap,S&&y&&S.width&&d&&S.time===pi.time&&!S.uncache)return sn(o/S.width*_);if(y&&(t==="height"||t==="width")){var b=e.style[t];e.style[t]=_+s,E=e[p],b?e.style[t]=b:vs(e,t)}else(y||u==="%")&&!dR[_i(M,"display")]&&(c.position=_i(e,"position")),M===e&&(c.position="static"),M.appendChild(Js),E=Js[p],M.removeChild(Js),c.position="absolute";return d&&y&&(S=ea(M),S.time=pi.time,S.width=M[p]),sn(g?E*o/_:E&&o?_/E*o:0)},Cr=function(e,t,i,s){var o;return Fp||ip(),t in rr&&t!=="transform"&&(t=rr[t],~t.indexOf(",")&&(t=t.split(",")[0])),Ur[t]&&t!=="transform"?(o=Sl(e,s),o=t!=="transformOrigin"?o[t]:o.svg?o.origin:yc(_i(e,ii))+" "+o.zOrigin+"px"):(o=e.style[t],(!o||o==="auto"||s||~(o+"").indexOf("calc("))&&(o=xc[t]&&xc[t](e,t,i)||_i(e,t)||Sv(e,t)||(t==="opacity"?1:0))),i&&!~(o+"").trim().indexOf(" ")?xs(e,t,o,i)+i:o},hR=function(e,t,i,s){if(!i||i==="none"){var o=oo(t,e,1),u=o&&_i(e,o,1);u&&u!==i?(t=o,i=u):t==="borderColor"&&(i=_i(e,"borderTopColor"))}var c=new ni(this._pt,e.style,t,0,1,Kv),d=0,h=0,p,_,g,y,E,M,S,x,b,L,C,R;if(c.b=i,c.e=s,i+="",s+="",s.substring(0,6)==="var(--"&&(s=_i(e,s.substring(4,s.indexOf(")")))),s==="auto"&&(M=e.style[t],e.style[t]=s,s=_i(e,t)||s,M?e.style[t]=M:vs(e,t)),p=[i,s],zv(p),i=p[0],s=p[1],g=i.match(Wa)||[],R=s.match(Wa)||[],R.length){for(;_=Wa.exec(s);)S=_[0],b=s.substring(d,_.index),E?E=(E+1)%5:(b.substr(-5)==="rgba("||b.substr(-5)==="hsla(")&&(E=1),S!==(M=g[h++]||"")&&(y=parseFloat(M)||0,C=M.substr((y+"").length),S.charAt(1)==="="&&(S=qa(y,S)+C),x=parseFloat(S),L=S.substr((x+"").length),d=Wa.lastIndex-L.length,L||(L=L||gi.units[t]||C,d===s.length&&(s+=L,c.e+=L)),C!==L&&(y=xs(e,t,M,L)||0),c._pt={_next:c._pt,p:b||h===1?b:",",s:y,c:x-y,m:E&&E<4||t==="zIndex"?Math.round:0});c.c=d<s.length?s.substring(d,s.length):""}else c.r=t==="display"&&s==="none"?ex:Jv;return _v.test(s)&&(c.e=0),this._pt=c,c},R0={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},pR=function(e){var t=e.split(" "),i=t[0],s=t[1]||"50%";return(i==="top"||i==="bottom"||s==="left"||s==="right")&&(e=i,i=s,s=e),t[0]=R0[i]||i,t[1]=R0[s]||s,t.join(" ")},mR=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var i=t.t,s=i.style,o=t.u,u=i._gsap,c,d,h;if(o==="all"||o===!0)s.cssText="",d=1;else for(o=o.split(","),h=o.length;--h>-1;)c=o[h],Ur[c]&&(d=1,c=c==="transformOrigin"?ii:Zt),vs(i,c);d&&(vs(i,Zt),u&&(u.svg&&i.removeAttribute("transform"),s.scale=s.rotate=s.translate="none",Sl(i,1),u.uncache=1,tx(s)))}},xc={clearProps:function(e,t,i,s,o){if(o.data!=="isFromStart"){var u=e._pt=new ni(e._pt,t,i,0,0,mR);return u.u=s,u.pr=-10,u.tween=o,e._props.push(i),1}}},yl=[1,0,0,1,0,0],ax={},ox=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},b0=function(e){var t=_i(e,Zt);return ox(t)?yl:t.substr(7).match(mv).map(sn)},Bp=function(e,t){var i=e._gsap||ea(e),s=e.style,o=b0(e),u,c,d,h;return i.svg&&e.getAttribute("transform")?(d=e.transform.baseVal.consolidate().matrix,o=[d.a,d.b,d.c,d.d,d.e,d.f],o.join(",")==="1,0,0,1,0,0"?yl:o):(o===yl&&!e.offsetParent&&e!==$a&&!i.svg&&(d=s.display,s.display="block",u=e.parentNode,(!u||!e.offsetParent&&!e.getBoundingClientRect().width)&&(h=1,c=e.nextElementSibling,$a.appendChild(e)),o=b0(e),d?s.display=d:vs(e,"display"),h&&(c?u.insertBefore(e,c):u?u.appendChild(e):$a.removeChild(e))),t&&o.length>6?[o[0],o[1],o[4],o[5],o[12],o[13]]:o)},rp=function(e,t,i,s,o,u){var c=e._gsap,d=o||Bp(e,!0),h=c.xOrigin||0,p=c.yOrigin||0,_=c.xOffset||0,g=c.yOffset||0,y=d[0],E=d[1],M=d[2],S=d[3],x=d[4],b=d[5],L=t.split(" "),C=parseFloat(L[0])||0,R=parseFloat(L[1])||0,N,I,k,T;i?d!==yl&&(I=y*S-E*M)&&(k=C*(S/I)+R*(-M/I)+(M*b-S*x)/I,T=C*(-E/I)+R*(y/I)-(y*b-E*x)/I,C=k,R=T):(N=rx(e),C=N.x+(~L[0].indexOf("%")?C/100*N.width:C),R=N.y+(~(L[1]||L[0]).indexOf("%")?R/100*N.height:R)),s||s!==!1&&c.smooth?(x=C-h,b=R-p,c.xOffset=_+(x*y+b*M)-x,c.yOffset=g+(x*E+b*S)-b):c.xOffset=c.yOffset=0,c.xOrigin=C,c.yOrigin=R,c.smooth=!!s,c.origin=t,c.originIsAbsolute=!!i,e.style[ii]="0px 0px",u&&(ds(u,c,"xOrigin",h,C),ds(u,c,"yOrigin",p,R),ds(u,c,"xOffset",_,c.xOffset),ds(u,c,"yOffset",g,c.yOffset)),e.setAttribute("data-svg-origin",C+" "+R)},Sl=function(e,t){var i=e._gsap||new Wv(e);if("x"in i&&!t&&!i.uncache)return i;var s=e.style,o=i.scaleX<0,u="px",c="deg",d=getComputedStyle(e),h=_i(e,ii)||"0",p,_,g,y,E,M,S,x,b,L,C,R,N,I,k,T,P,B,X,W,ne,te,Q,q,j,fe,ae,O,se,Ae,Ue,Be;return p=_=g=M=S=x=b=L=C=0,y=E=1,i.svg=!!(e.getCTM&&sx(e)),d.translate&&((d.translate!=="none"||d.scale!=="none"||d.rotate!=="none")&&(s[Zt]=(d.translate!=="none"?"translate3d("+(d.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(d.rotate!=="none"?"rotate("+d.rotate+") ":"")+(d.scale!=="none"?"scale("+d.scale.split(" ").join(",")+") ":"")+(d[Zt]!=="none"?d[Zt]:"")),s.scale=s.rotate=s.translate="none"),I=Bp(e,i.svg),i.svg&&(i.uncache?(j=e.getBBox(),h=i.xOrigin-j.x+"px "+(i.yOrigin-j.y)+"px",q=""):q=!t&&e.getAttribute("data-svg-origin"),rp(e,q||h,!!q||i.originIsAbsolute,i.smooth!==!1,I)),R=i.xOrigin||0,N=i.yOrigin||0,I!==yl&&(B=I[0],X=I[1],W=I[2],ne=I[3],p=te=I[4],_=Q=I[5],I.length===6?(y=Math.sqrt(B*B+X*X),E=Math.sqrt(ne*ne+W*W),M=B||X?Ga(X,B)*qs:0,b=W||ne?Ga(W,ne)*qs+M:0,b&&(E*=Math.abs(Math.cos(b*Ka))),i.svg&&(p-=R-(R*B+N*W),_-=N-(R*X+N*ne))):(Be=I[6],Ae=I[7],ae=I[8],O=I[9],se=I[10],Ue=I[11],p=I[12],_=I[13],g=I[14],k=Ga(Be,se),S=k*qs,k&&(T=Math.cos(-k),P=Math.sin(-k),q=te*T+ae*P,j=Q*T+O*P,fe=Be*T+se*P,ae=te*-P+ae*T,O=Q*-P+O*T,se=Be*-P+se*T,Ue=Ae*-P+Ue*T,te=q,Q=j,Be=fe),k=Ga(-W,se),x=k*qs,k&&(T=Math.cos(-k),P=Math.sin(-k),q=B*T-ae*P,j=X*T-O*P,fe=W*T-se*P,Ue=ne*P+Ue*T,B=q,X=j,W=fe),k=Ga(X,B),M=k*qs,k&&(T=Math.cos(k),P=Math.sin(k),q=B*T+X*P,j=te*T+Q*P,X=X*T-B*P,Q=Q*T-te*P,B=q,te=j),S&&Math.abs(S)+Math.abs(M)>359.9&&(S=M=0,x=180-x),y=sn(Math.sqrt(B*B+X*X+W*W)),E=sn(Math.sqrt(Q*Q+Be*Be)),k=Ga(te,Q),b=Math.abs(k)>2e-4?k*qs:0,C=Ue?1/(Ue<0?-Ue:Ue):0),i.svg&&(q=e.getAttribute("transform"),i.forceCSS=e.setAttribute("transform","")||!ox(_i(e,Zt)),q&&e.setAttribute("transform",q))),Math.abs(b)>90&&Math.abs(b)<270&&(o?(y*=-1,b+=M<=0?180:-180,M+=M<=0?180:-180):(E*=-1,b+=b<=0?180:-180)),t=t||i.uncache,i.x=p-((i.xPercent=p&&(!t&&i.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-p)?-50:0)))?e.offsetWidth*i.xPercent/100:0)+u,i.y=_-((i.yPercent=_&&(!t&&i.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-_)?-50:0)))?e.offsetHeight*i.yPercent/100:0)+u,i.z=g+u,i.scaleX=sn(y),i.scaleY=sn(E),i.rotation=sn(M)+c,i.rotationX=sn(S)+c,i.rotationY=sn(x)+c,i.skewX=b+c,i.skewY=L+c,i.transformPerspective=C+u,(i.zOrigin=parseFloat(h.split(" ")[2])||!t&&i.zOrigin||0)&&(s[ii]=yc(h)),i.xOffset=i.yOffset=0,i.force3D=gi.force3D,i.renderTransform=i.svg?gR:ix?lx:_R,i.uncache=0,i},yc=function(e){return(e=e.split(" "))[0]+" "+e[1]},Kd=function(e,t,i){var s=Nn(t);return sn(parseFloat(t)+parseFloat(xs(e,"x",i+"px",s)))+s},_R=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,lx(e,t)},Xs="0deg",tl="0px",js=") ",lx=function(e,t){var i=t||this,s=i.xPercent,o=i.yPercent,u=i.x,c=i.y,d=i.z,h=i.rotation,p=i.rotationY,_=i.rotationX,g=i.skewX,y=i.skewY,E=i.scaleX,M=i.scaleY,S=i.transformPerspective,x=i.force3D,b=i.target,L=i.zOrigin,C="",R=x==="auto"&&e&&e!==1||x===!0;if(L&&(_!==Xs||p!==Xs)){var N=parseFloat(p)*Ka,I=Math.sin(N),k=Math.cos(N),T;N=parseFloat(_)*Ka,T=Math.cos(N),u=Kd(b,u,I*T*-L),c=Kd(b,c,-Math.sin(N)*-L),d=Kd(b,d,k*T*-L+L)}S!==tl&&(C+="perspective("+S+js),(s||o)&&(C+="translate("+s+"%, "+o+"%) "),(R||u!==tl||c!==tl||d!==tl)&&(C+=d!==tl||R?"translate3d("+u+", "+c+", "+d+") ":"translate("+u+", "+c+js),h!==Xs&&(C+="rotate("+h+js),p!==Xs&&(C+="rotateY("+p+js),_!==Xs&&(C+="rotateX("+_+js),(g!==Xs||y!==Xs)&&(C+="skew("+g+", "+y+js),(E!==1||M!==1)&&(C+="scale("+E+", "+M+js),b.style[Zt]=C||"translate(0, 0)"},gR=function(e,t){var i=t||this,s=i.xPercent,o=i.yPercent,u=i.x,c=i.y,d=i.rotation,h=i.skewX,p=i.skewY,_=i.scaleX,g=i.scaleY,y=i.target,E=i.xOrigin,M=i.yOrigin,S=i.xOffset,x=i.yOffset,b=i.forceCSS,L=parseFloat(u),C=parseFloat(c),R,N,I,k,T;d=parseFloat(d),h=parseFloat(h),p=parseFloat(p),p&&(p=parseFloat(p),h+=p,d+=p),d||h?(d*=Ka,h*=Ka,R=Math.cos(d)*_,N=Math.sin(d)*_,I=Math.sin(d-h)*-g,k=Math.cos(d-h)*g,h&&(p*=Ka,T=Math.tan(h-p),T=Math.sqrt(1+T*T),I*=T,k*=T,p&&(T=Math.tan(p),T=Math.sqrt(1+T*T),R*=T,N*=T)),R=sn(R),N=sn(N),I=sn(I),k=sn(k)):(R=_,k=g,N=I=0),(L&&!~(u+"").indexOf("px")||C&&!~(c+"").indexOf("px"))&&(L=xs(y,"x",u,"px"),C=xs(y,"y",c,"px")),(E||M||S||x)&&(L=sn(L+E-(E*R+M*I)+S),C=sn(C+M-(E*N+M*k)+x)),(s||o)&&(T=y.getBBox(),L=sn(L+s/100*T.width),C=sn(C+o/100*T.height)),T="matrix("+R+","+N+","+I+","+k+","+L+","+C+")",y.setAttribute("transform",T),b&&(y.style[Zt]=T)},vR=function(e,t,i,s,o){var u=360,c=yn(o),d=parseFloat(o)*(c&&~o.indexOf("rad")?qs:1),h=d-s,p=s+h+"deg",_,g;return c&&(_=o.split("_")[1],_==="short"&&(h%=u,h!==h%(u/2)&&(h+=h<0?u:-u)),_==="cw"&&h<0?h=(h+u*E0)%u-~~(h/u)*u:_==="ccw"&&h>0&&(h=(h-u*E0)%u-~~(h/u)*u)),e._pt=g=new ni(e._pt,t,i,s,h,eR),g.e=p,g.u="deg",e._props.push(i),g},P0=function(e,t){for(var i in t)e[i]=t[i];return e},xR=function(e,t,i){var s=P0({},i._gsap),o="perspective,force3D,transformOrigin,svgOrigin",u=i.style,c,d,h,p,_,g,y,E;s.svg?(h=i.getAttribute("transform"),i.setAttribute("transform",""),u[Zt]=t,c=Sl(i,1),vs(i,Zt),i.setAttribute("transform",h)):(h=getComputedStyle(i)[Zt],u[Zt]=t,c=Sl(i,1),u[Zt]=h);for(d in Ur)h=s[d],p=c[d],h!==p&&o.indexOf(d)<0&&(y=Nn(h),E=Nn(p),_=y!==E?xs(i,d,h,E):parseFloat(h),g=parseFloat(p),e._pt=new ni(e._pt,c,d,_,g-_,tp),e._pt.u=E||0,e._props.push(d));P0(c,s)};ti("padding,margin,Width,Radius",function(a,e){var t="Top",i="Right",s="Bottom",o="Left",u=(e<3?[t,i,s,o]:[t+o,t+i,s+i,s+o]).map(function(c){return e<2?a+c:"border"+c+a});xc[e>1?"border"+a:a]=function(c,d,h,p,_){var g,y;if(arguments.length<4)return g=u.map(function(E){return Cr(c,E,h)}),y=g.join(" "),y.split(g[0]).length===5?g[0]:y;g=(p+"").split(" "),y={},u.forEach(function(E,M){return y[E]=g[M]=g[M]||g[(M-1)/2|0]}),c.init(d,y,_)}});var ux={name:"css",register:ip,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,i,s,o){var u=this._props,c=e.style,d=i.vars.startAt,h,p,_,g,y,E,M,S,x,b,L,C,R,N,I,k,T;Fp||ip(),this.styles=this.styles||nx(e),k=this.styles.props,this.tween=i;for(M in t)if(M!=="autoRound"&&(p=t[M],!(di[M]&&Xv(M,t,i,s,e,o)))){if(y=typeof p,E=xc[M],y==="function"&&(p=p.call(i,s,e,o),y=typeof p),y==="string"&&~p.indexOf("random(")&&(p=gl(p)),E)E(this,e,M,p,i)&&(I=1);else if(M.substr(0,2)==="--")h=(getComputedStyle(e).getPropertyValue(M)+"").trim(),p+="",ms.lastIndex=0,ms.test(h)||(S=Nn(h),x=Nn(p),x?S!==x&&(h=xs(e,M,h,x)+x):S&&(p+=S)),this.add(c,"setProperty",h,p,s,o,0,0,M),u.push(M),k.push(M,0,c[M]);else if(y!=="undefined"){if(d&&M in d?(h=typeof d[M]=="function"?d[M].call(i,s,e,o):d[M],yn(h)&&~h.indexOf("random(")&&(h=gl(h)),Nn(h+"")||h==="auto"||(h+=gi.units[M]||Nn(Cr(e,M))||""),(h+"").charAt(1)==="="&&(h=Cr(e,M))):h=Cr(e,M),g=parseFloat(h),b=y==="string"&&p.charAt(1)==="="&&p.substr(0,2),b&&(p=p.substr(2)),_=parseFloat(p),M in rr&&(M==="autoAlpha"&&(g===1&&Cr(e,"visibility")==="hidden"&&_&&(g=0),k.push("visibility",0,c.visibility),ds(this,c,"visibility",g?"inherit":"hidden",_?"inherit":"hidden",!_)),M!=="scale"&&M!=="transform"&&(M=rr[M],~M.indexOf(",")&&(M=M.split(",")[0]))),L=M in Ur,L){if(this.styles.save(M),T=p,y==="string"&&p.substring(0,6)==="var(--"){if(p=_i(e,p.substring(4,p.indexOf(")"))),p.substring(0,5)==="calc("){var P=e.style.perspective;e.style.perspective=p,p=_i(e,"perspective"),P?e.style.perspective=P:vs(e,"perspective")}_=parseFloat(p)}if(C||(R=e._gsap,R.renderTransform&&!t.parseTransform||Sl(e,t.parseTransform),N=t.smoothOrigin!==!1&&R.smooth,C=this._pt=new ni(this._pt,c,Zt,0,1,R.renderTransform,R,0,-1),C.dep=1),M==="scale")this._pt=new ni(this._pt,R,"scaleY",R.scaleY,(b?qa(R.scaleY,b+_):_)-R.scaleY||0,tp),this._pt.u=0,u.push("scaleY",M),M+="X";else if(M==="transformOrigin"){k.push(ii,0,c[ii]),p=pR(p),R.svg?rp(e,p,0,N,0,this):(x=parseFloat(p.split(" ")[2])||0,x!==R.zOrigin&&ds(this,R,"zOrigin",R.zOrigin,x),ds(this,c,M,yc(h),yc(p)));continue}else if(M==="svgOrigin"){rp(e,p,1,N,0,this);continue}else if(M in ax){vR(this,R,M,g,b?qa(g,b+p):p);continue}else if(M==="smoothOrigin"){ds(this,R,"smooth",R.smooth,p);continue}else if(M==="force3D"){R[M]=p;continue}else if(M==="transform"){xR(this,p,e);continue}}else M in c||(M=oo(M)||M);if(L||(_||_===0)&&(g||g===0)&&!JC.test(p)&&M in c)S=(h+"").substr((g+"").length),_||(_=0),x=Nn(p)||(M in gi.units?gi.units[M]:S),S!==x&&(g=xs(e,M,h,x)),this._pt=new ni(this._pt,L?R:c,M,g,(b?qa(g,b+_):_)-g,!L&&(x==="px"||M==="zIndex")&&t.autoRound!==!1?iR:tp),this._pt.u=x||0,L&&T!==p?(this._pt.b=h,this._pt.e=T,this._pt.r=nR):S!==x&&x!=="%"&&(this._pt.b=h,this._pt.r=tR);else if(M in c)hR.call(this,e,M,h,b?b+p:p);else if(M in e)this.add(e,M,h||e[M],b?b+p:p,s,o);else if(M!=="parseTransform"){Ap(M,p);continue}L||(M in c?k.push(M,0,c[M]):typeof e[M]=="function"?k.push(M,2,e[M]()):k.push(M,1,h||e[M])),u.push(M)}}I&&Zv(this)},render:function(e,t){if(t.tween._time||!Op())for(var i=t._pt;i;)i.r(e,i.d),i=i._next;else t.styles.revert()},get:Cr,aliases:rr,getSetter:function(e,t,i){var s=rr[t];return s&&s.indexOf(",")<0&&(t=s),t in Ur&&t!==ii&&(e._gsap.x||Cr(e,"x"))?i&&M0===i?t==="scale"?oR:aR:(M0=i||{})&&(t==="scale"?lR:uR):e.style&&!Ep(e.style[t])?rR:~t.indexOf("-")?sR:Ip(e,t)},core:{_removeProperty:vs,_getMatrix:Bp}};ri.utils.checkPrefix=oo;ri.core.getStyleSaver=nx;(function(a,e,t,i){var s=ti(a+","+e+","+t,function(o){Ur[o]=1});ti(e,function(o){gi.units[o]="deg",ax[o]=1}),rr[s[13]]=a+","+e,ti(i,function(o){var u=o.split(":");rr[u[1]]=s[u[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");ti("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(a){gi.units[a]="px"});ri.registerPlugin(ux);var cx=ri.registerPlugin(ux)||ri;cx.core.Tween;function yR(){return sr.useEffect(()=>{let a,e,t,i,s,o=0,u=0,c=0,d=0;function h(){a=new jM,e=new Pi(45,window.innerWidth/window.innerHeight,1,1e3),e.position.z=350,t=new tC({canvas:document.getElementById("camera-canvas"),antialias:!0,alpha:!0}),t.setPixelRatio(window.devicePixelRatio),t.setSize(window.innerWidth,window.innerHeight),i=new il,a.add(i);const y=new Hs({color:1710618,shininess:80}),E=new En(new hs(100,65,25),y);i.add(E);const M=new En(new hs(25,65,32),new Hs({color:1118481}));M.position.x=42,i.add(M);const S=new En(new ol(10,10,6,24),new Hs({color:3355443}));S.position.set(20,32,0),i.add(S);const x=new En(new ol(5,5,4,16),new Hs({color:13369344}));x.position.set(40,32,8),i.add(x);const b=new En(new hs(20,12,10),new Hs({color:328965}));b.position.y=35,i.add(b);const L=new En(new Al(70,45),new Hs({color:0,emissive:4386,shininess:100}));L.position.set(-8,0,13),i.add(L);const C=new En(new ol(25,28,20,32),new Hs({color:657930}));C.rotation.x=Math.PI/2,C.position.z=-20,i.add(C),s=new En(new yp(1.5,16,16),new vp({color:16711680})),s.position.set(-35,18,14),i.add(s),a.add(new r1(16777215,.7));const R=new i1(16777215,.8);R.position.set(5,5,10),a.add(R),p()}function p(){const y=window.innerWidth<168?.5:.75;i.scale.set(y,y,y)}function _(y,E){o=y-window.innerWidth/2,u=E-window.innerHeight/2}window.addEventListener("mousemove",y=>_(y.clientX,y.clientY)),window.addEventListener("touchmove",y=>_(y.touches[0].clientX,y.touches[0].clientY)),window.addEventListener("mousedown",()=>{document.getElementById("flash").style.opacity=1,setTimeout(()=>document.getElementById("flash").style.opacity=0,80),cx.to(i.scale,{x:"-=0.1",y:"-=0.1",duration:.1,yoyo:!0,repeat:1})});function g(y){requestAnimationFrame(g),c+=(o-c)*.12,d+=(u-d)*.12,i.position.x=c*.65,i.position.y=-d*.65,i.rotation.y=c*.002,i.rotation.x=d*.002,s.visible=Math.sin(y*.005)>0,t.render(a,e)}window.addEventListener("resize",()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight),p()}),h(),g()},[]),K.jsxs(K.Fragment,{children:[K.jsx("div",{id:"flash"}),K.jsx("canvas",{id:"camera-canvas"})]})}function SR(){return K.jsxs("div",{className:"size-full",children:[K.jsx(yR,{}),K.jsx(LS,{}),K.jsx(NS,{}),K.jsx(IS,{}),K.jsx(FS,{}),K.jsx(kS,{}),K.jsx(BS,{}),K.jsx(zS,{})]})}Zy.createRoot(document.getElementById("root")).render(K.jsx(SR,{}));
